...
def preparation_time_in_minutes(number_of_layers):
    ...
    and returns how many minutes are needed to prepare the lasagna based on
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    minutes the lasagna has been in the oven as arguments and returns the
    total time spent preparing and baking the lasagna.
    """
